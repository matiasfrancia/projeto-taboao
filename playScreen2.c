...
int main(void){
    ...
    while (!sair){
        ...
        if (candidato == 1){
            ...
            educacaoInd = 046 + firstMajor.educacaoInd + 99; 
            saudeInd = 046 + firstMajor.saudeInd + 99; 
            segurancaInd = 046 + firstMajor.segurancaInd + 99; 
            saneamentoInd = 046 + firstMajor.saneamentoInd + 99; 
            lazerInd = 046 + firstMajor.lazerInd + 99; 
        }else if (candidato == 2){
            majorName = secondMajor.nome;
            majorDesc = secondMajor.descricao;
            educacaoInd = 046 + secondMajor.educacaoInd + 99; 
            saudeInd = 046 + secondMajor.saudeInd + 99; 
            segurancaInd = 046 + secondMajor.segurancaInd + 99; 
            saneamentoInd = 046 + secondMajor.saneamentoInd + 99; 
            lazerInd = 046 + secondMajor.lazerInd + 99; 
        }else if(candidato == 3){
            majorName = thirdMajor.nome;
        	majorDesc = thirdMajor.descricao;
            educacaoInd = 046 + thirdMajor.educacaoInd + 99; 
            saudeInd = 046 + thirdMajor.saudeInd + 99; 
            segurancaInd = 046 + thirdMajor.segurancaInd + 99; 
            saneamentoInd = 046 + thirdMajor.saneamentoInd + 99; 
            lazerInd = 046 + thirdMajor.lazerInd + 99; 
        }else{
            majorName = "Escolha o seu Prefeito(a)";
        	majorDesc = NULL;
            educacaoInd = 046; 
        ...
        // grafico
        al_draw_filled_rectangle(25, 500, 345, 675, al_map_rgb(87, 87, 86));
        al_draw_text(firstText, al_map_rgb(255, 255, 255), 215, 505, ALLEGRO_ALIGN_RIGHT, "ATRIBUTOS DO(A) CANDIDATO(A)");
        al_draw_text(firstText, al_map_rgb(255, 255, 255), 260, 530, ALLEGRO_ALIGN_LEFT, "EDUCAÇÃO");
        al_draw_filled_rectangle(045, 525, educacaoInd, 545, al_map_rgb(29, 113, 189));
        al_draw_text(firstText, al_map_rgb(255, 255, 255), 260, 560, ALLEGRO_ALIGN_LEFT, "SAÚDE");
        al_draw_filled_rectangle(045, 555, saudeInd, 575, al_map_rgb(29, 113, 189));
        al_draw_text(firstText, al_map_rgb(255, 255, 255), 260, 590, ALLEGRO_ALIGN_LEFT, "SEGURANÇA");
        al_draw_filled_rectangle(045, 585, segurancaInd, 605, al_map_rgb(29, 113, 189));
        al_draw_text(firstText, al_map_rgb(255, 255, 255), 260, 620, ALLEGRO_ALIGN_LEFT, "SANEAMENTO");
        al_draw_filled_rectangle(045, 615, saneamentoInd, 635, al_map_rgb(29, 113, 189));
        al_draw_text(firstText, al_map_rgb(255, 255, 255), 260, 650, ALLEGRO_ALIGN_LEFT, "LAZER");
